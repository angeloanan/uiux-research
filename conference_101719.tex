...
\begin{abstract}
    In this paper, we present a correlational study between user interface attributes to user experience in a website. For this study, 15 random websites with varying levels of the user interface are classified into three categories: Bad UI, Good UI, and Best UI with 10 people volunteered to be the research subject for this study. The attributes of the User Interface In this study are Symmetry, Colorfulness, and Visual Complexity. We use UMUX to measure the user experience of a website numerically and compare it with UI attributes using scatterplot. We found that there is a positive correlation between the Symmetric website and the UMUX score and there is an inverse correlation between Visually complex websites and UMUX scores.
\end{abstract}
...
\begin{figure}[!ht]
    \centering
    \scalebox{0.57}{
        \input{./graphs/visual_complexity.pgf}
    }
    \caption{Plot graph of Visual Complexity score vs UMUX score}
