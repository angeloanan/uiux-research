...
\makeatletter
% https://tex.stackexchange.com/questions/474382/ieee-styling-authors-with-5-columns#474394
\newcommand{\newlineauthors}{%
...
\author{\IEEEauthorblockN{1\textsuperscript{st} Christopher Angelo}
    \IEEEauthorblockA{\textit{Computer Science Departement} \\
        \textit{School of Computer Science}\\
        Jakarta, Indonesia 11480 \\
        christopher.angelo@binus.ac.id}
    \and
    \IEEEauthorblockN{2\textsuperscript{nd} Diven Clementius}
    \IEEEauthorblockA{\textit{Computer Science Departement} \\
        \textit{School of Computer Science}\\
        Jakarta, Indonesia 11480 \\
        diven.clementius@binus.ac.id}
    \and
    \IEEEauthorblockN{3\textsuperscript{rd} Kensi Chandrawan}
    \IEEEauthorblockA{\textit{Computer Science Departement} \\
        \textit{School of Computer Science}\\
        Jakarta, Indonesia 11480 \\
        kensi.chandrawan@binus.ac.id}
    \newlineauthors{}
    \IEEEauthorblockN{4\textsuperscript{th} Anderies}
    \IEEEauthorblockA{\textit{Computer Science Departement} \\
        \textit{School of Computer Science}\\
        Jakarta, Indonesia 11480 \\
        anderies@binus.edu}
    \and
    \IEEEauthorblockN{5\textsuperscript{th} Irene Anindaputri Iswanto}
    \IEEEauthorblockA{\textit{Computer Science Departement} \\
        \textit{School of Computer Science}\\
        Jakarta, Indonesia 11480 \\
